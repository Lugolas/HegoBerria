...
class Publications  implements FixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $evenementAnniversaireVincent->setIcone('anniversaire.png');
        ...
        $evenementDepartLune->setIcone('lune.jpg');
        ...
        $evenementRetourTerre->setIcone('terre.jpg');
        ...
        $actualitePrixPaixClaudia->setIcone('prix_nobel.png');
        ...
        $actualiteEtudiantLoto->setIcone("loto.png");
        ...
        $actualiteCourseEtudes->setIcone("course.png");
